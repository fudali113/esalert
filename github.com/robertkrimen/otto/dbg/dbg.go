...
/*
Package dbg is a println/printf/mylog-debugging utility library.
...
By default, dbg uses mylog (mylog.Println, mylog.Printf, mylog.Panic, etc.) for output.
...
func (self Dbgr) dbgf(values ...interface{}) {
	...
	if frmt.check {
		// We do not actually emit to the mylog, but panic if
...
//
//      *mylog.Logger         Print*/Panic*/Fatal* of the logger
//      io.Writer           -
//      nil                 Reset to the default output (os.Stderr)
//      "mylog"               Print*/Panic*/Fatal* via the "mylog" package
//
